...
from PySide6.QtGui import QPainter, QColor, QPen, QPixmap, QCursor, QGuiApplication

class SnippingWidget(QWidget):
    snippet_taken = Signal(str)
    region_selected = Signal(QRect) # New signal for region selection
    closed = Signal()
