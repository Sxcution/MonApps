...
from PySide6.QtWidgets import (QDialog, QVBoxLayout, QHBoxLayout, QLabel, 
                            ...
                            QGridLayout)
from PySide6.QtCore import Qt, QTimer, QRect, Signal, QPointF
...
class ImageSearchDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        self.combo_goto_not_found.addItems(["Bắt đầu", "Kết thúc", "Tiếp theo", "Chuyển Đến"])
        self.combo_goto_not_found.setMinimumWidth(120)
        self.combo_goto_not_found.currentTextChanged.connect(self.on_goto_not_found_changed)
        ...
        goto_not_found_layout.addWidget(self.lbl_goto_not_found_step)
        ...
        self.spin_goto_not_found_step.setMinimumWidth(80)
        self.spin_goto_not_found_step.setVisible(False)
        goto_not_found_layout.addWidget(self.spin_goto_not_found_step)
    ...
    def load_event_data(self):
        ...
        if goto_found.startswith('Step '):
            ...
            try:
                ...
                self.combo_goto_found.setCurrentText("Chuyển Đến")
                ...
                self.combo_goto_found.setCurrentText(goto_map.get(goto_found, 'Tiếp theo'))
        else:
            goto_map = {'Next': 'Tiếp theo', 'Start': 'Bắt đầu', 'End': 'Kết thúc'}
            self.combo_goto_found.setCurrentText(goto_map.get(goto_found, 'Tiếp theo'))
        ...
        if goto_not_found.startswith('Step '):
            ...
            try:
                ...
                self.combo_goto_not_found.setCurrentText("Chuyển Đến")
                ...
                goto_map = {'Next': 'Tiếp theo', 'Start': 'Bắt đầu', 'End': 'Kết thúc'}
                self.combo_goto_not_found.setCurrentText(goto_map.get(goto_not_found, 'Bắt đầu'))
        else:
            goto_map = {'Next': 'Tiếp theo', 'Start': 'Bắt đầu', 'End': 'Kết thúc'}
            self.combo_goto_not_found.setCurrentText(goto_map.get(goto_not_found, 'Bắt đầu'))
    ...
    def get_data(self):
        ...
        # Handle goto_found
        goto_found_text = self.combo_goto_found.currentText()
        if goto_found_text == "Chuyển Đến":
            ...
            goto_found_value = goto_map.get(goto_found_text, 'Next')
        
        # Handle goto_not_found
        goto_not_found_text = self.combo_goto_not_found.currentText()
        if goto_not_found_text == "Chuyển Đến":
            ...
            goto_not_found_value = goto_map.get(goto_not_found_text, 'Start')
